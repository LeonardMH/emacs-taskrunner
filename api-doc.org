**NOTE**: All of the documentation below is a product of the original repository
and is not necessarily reflective of the current state of the project or its
intended goals, I will attempt to ensure documentation is update appropriately
as changes are made.
